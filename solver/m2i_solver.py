...
class M2ISolver(object):
    def __init__(self, train_y, train_thh1, train_thh2, train_ske1,
                 train_ske2, train_shh, test_y, test_thh1, test_thh2,
                 test_ske1, test_ske2, test_shh):
    ...
    def get_solver(self):
        ...
        solver = switcher.get(0, lambda: "nothing")
    ...
    def set_view_name(self, view):
        ...
        # Get the function from switcher dictionary
        self.view = switcher.get(view, "nothing")

    def solve(self, view):
        self.set_view_name(view)

        solver = self.get_solver()
        acc, output, target = solver()
    ...
    def create_srnn(self):
        ...
        self.input_var2 = tensor.ftensor3('X2')
        self.input_var3 = tensor.ftensor3('X3')
        ...
        l_thh1 = llayers.InputLayer(shape=shape1, input_var=self.input_var1)
        l_thh2 = llayers.InputLayer(shape=shape2, input_var=self.input_var2)
        l_shh = llayers.InputLayer(shape=shape3, input_var=self.input_var3)
        ...
        l_concat = llayers.ConcatLayer([l_lthh1, l_lshh, l_lthh2], axis=2)
    ...
    def create_function(self):
        ...
        self.loss = M2ISolver.create_loss(self.prediction, self.l_out, self.target_var)
        ...
        self.test_fn = M2ISolver.create_testfn(test_dim, self.test_prediction)
